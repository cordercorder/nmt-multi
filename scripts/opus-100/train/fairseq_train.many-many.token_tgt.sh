...
save_dir=${project_dir}/data/opus-100-corpus/many-many.token_tgt/checkpoint
tensorboard_logdir=${project_dir}/data/opus-100-corpus/many-many.token_tgt/tensorboard_logdir
