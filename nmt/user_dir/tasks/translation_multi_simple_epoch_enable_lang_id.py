...
# use ..data.multilingual_data_manager MultilingualDatasetManager to enable lang id in sample
...
@register_task("translation_multi_simple_epoch_enable_lang_id")
class TranslationMultiSimpleEpochEnableLangIdTask(LegacyFairseqTask):
    """
